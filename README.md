...
RDR(redis data reveal) is a tool to parse redis rdbfile. Comparing to [redis-rdb-tools](https://github.com/sripathikrishnan/redis-rdb-tools), rdr is implemented by golang, much faster (5GB rdbfile takes about 2min on my PC).
